        ...
        <div class="tp-banner" >
            <ul>	<!-- SLIDE  -->
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    <!-- MAIN IMAGE -->
                    <img src="{{ Theme::url('images/slidebg1.jpg') }}"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endspeed="500"
                         data-endeasing="Power4.easeIn"
                         style="z-index: 3"><img src="{{ Theme::url('images/woman.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption skewfromrightshort customout"
                         ...
                         data-endeasing="Power4.easeIn"
                         data-captionhidden="on"
                         style="z-index: 9"><img src="{{ Theme::url('images/graph.png') }}" alt="" data-ww="52" data-hh="44">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Power4.easeIn"
                         data-captionhidden="on"
                         style="z-index: 16"><img src="{{ Theme::url('images/star.png') }}" alt="" data-ww="20" data-hh="20">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Power4.easeIn"
                         data-captionhidden="on"
                         style="z-index: 17"><img src="{{ Theme::url('images/star.png') }}" alt="" data-ww="20" data-hh="20">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Power4.easeIn"
                         data-captionhidden="on"
                         style="z-index: 18"><img src="{{ Theme::url('images/star.png') }}" alt="" data-ww="20" data-hh="20">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Power4.easeIn"
                         data-captionhidden="on"
                         style="z-index: 19"><img src="{{ Theme::url('images/star.png') }}" alt="" data-ww="20" data-hh="20">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Power4.easeIn"
                         data-captionhidden="on"
                         style="z-index: 20"><img src="{{ Theme::url('images/star.png') }}" alt="" data-ww="20" data-hh="20">
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    <!-- MAIN IMAGE -->
                    <img src="{{ Theme::url('images/darkblurbg.jpg') }}" alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption customin"
                         ...
                         data-endspeed="300"
                         style="z-index: 2"><img src="{{ Theme::url('images/macbook2.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin"
                         ...
                         data-easing="Power3.easeInOut"
                         data-endspeed="300"
                         style="z-index: 3"><img src="{{ Theme::url('images/imac1.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin"
                         ...
                         data-easing="Power3.easeInOut"
                         data-endspeed="300"
                         style="z-index: 4"><img src="{{ Theme::url('images/lupe_macbook.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin"
                         ...
                         data-easing="Power3.easeInOut"
                         data-endspeed="300"
                         style="z-index: 5"><img src="{{ Theme::url('images/lupe_imac.png') }}" alt="">
                    </div>
                ...
                <li data-transition="slidedown" data-slotamount="7" data-masterspeed="1000" >
                    <!-- MAIN IMAGE -->
                    <img src="{{ Theme::url('images/transparent.png') }}" style='background-color:#b2c4cc' alt=""  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption customin skewtoleft"
                         ...
                         style="z-index: 2"><img src="{{ Theme::url('images/cloud2.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin skewtoleft"
                         ...
                         data-endspeed="400"
                         data-endeasing="Back.easeIn"
                         style="z-index: 3"><img src="{{ Theme::url('images/cloud3.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin skewtoleft"
                         ...
                         data-endspeed="400"
                         data-endeasing="Back.easeIn"
                         style="z-index: 4"><img src="{{ Theme::url('images/cloud1.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfb ltl"
                         ...
                         data-endeasing="Back.easeIn"
                         data-captionhidden="on"
                         style="z-index: 5"><img src="{{ Theme::url('images/hill3.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfb ltl"
                         ...
                         data-endeasing="Back.easeIn"
                         data-captionhidden="on"
                         style="z-index: 6"><img src="{{ Theme::url('images/hill4.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfb ltl"
                         ...
                         data-endeasing="Back.easeIn"
                         data-captionhidden="on"
                         style="z-index: 8"><img src="{{ Theme::url('images/hill2.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfb ltl"
                         ...
                         data-endeasing="Back.easeIn"
                         data-captionhidden="on"
                         style="z-index: 9"><img src="{{ Theme::url('images/hill1.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfb ltl"
                         ...
                         data-endeasing="Back.easeIn"
                         data-captionhidden="on"
                         style="z-index: 10"><img src="{{ Theme::url('images/hill2.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption lfb skewtoleft"
                         ...
                         data-endspeed="400"
                         data-endeasing="Power1.easeIn"
                         style="z-index: 11"><img src="{{ Theme::url('images/guy1.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption lfb skewtoleft"
                         ...
                         data-endspeed="400"
                         data-endeasing="Power1.easeIn"
                         style="z-index: 12"><img src="{{ Theme::url('images/guy2.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin ltl"
                         ...
                         data-endspeed="400"
                         data-endeasing="Back.easeIn"
                         style="z-index: 13"><img src="{{ Theme::url('images/icon_photo.png') }}" alt="">
                    </div>
                ...
                <li data-transition="slideleft" data-slotamount="7" data-masterspeed="2000" >
                    ...
                    <div class="tp-caption customin"
                         ...
                         data-endspeed="300"
                         data-captionhidden="on"
                         style="z-index: 13"><img src="{{ Theme::url('images/tree.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-easing="Back.easeOut"
                         data-endspeed="300"
                         style="z-index: 14"><img src="{{ Theme::url('images/clock2.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin skewtoright"
                         ...
                         data-endspeed="600"
                         data-endeasing="Power4.easeIn"
                         style="z-index: 15"><img src="{{ Theme::url('images/guy3.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin skewtoright"
                         ...
                         data-endspeed="600"
                         data-endeasing="Power4.easeIn"
                         style="z-index: 16"><img src="{{ Theme::url('images/guy4.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-captionhidden="on"
                         style="z-index: 17"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Bounce.easeOut"
                         data-captionhidden="on"
                         style="z-index: 18"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Bounce.easeOut"
                         data-captionhidden="on"
                         style="z-index: 19"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Bounce.easeOut"
                         data-captionhidden="on"
                         style="z-index: 20"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Bounce.easeOut"
                         data-captionhidden="on"
                         style="z-index: 21"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Bounce.easeOut"
                         data-captionhidden="on"
                         style="z-index: 22"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Bounce.easeOut"
                         data-captionhidden="on"
                         style="z-index: 23"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                    ...
                    <div class="tp-caption customin customout"
                         ...
                         data-endeasing="Bounce.easeOut"
                         data-captionhidden="on"
                         style="z-index: 24"><img src="{{ Theme::url('images/apple.png') }}" alt="">
                    </div>
                </li>
                <!-- SLIDE  -->
                <li data-transition="zoomin" data-slotamount="7" data-masterspeed="600" >
                    <!-- MAIN IMAGE -->
                    <img src="{{ Theme::url('images/videobg1.jpg') }}" alt="videobg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    ...
                    <div class="tp-caption sft customout"
                         ...
                         data-endspeed="500"
                         data-captionhidden="on"
                         style="z-index: 7"><img src="{{ Theme::url('images/videoshadow.png') }}" alt="">
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    <!-- MAIN IMAGE -->
                    <img src="{{ Theme::url('images/transparent.png') }}"  alt=""  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
...
@push('scripts')
{!! Theme::script('js/plugins/slider-revolution/js/jquery.themepunch.plugins.min.js') !!}
{!! Theme::script('js/plugins/slider-revolution/js/jquery.themepunch.revolution.min.js') !!}
{!! Theme::style('css/plugins/slider-revolution/css/settings.css') !!}
@endpush
